...
function ReactTabs({ industryType }) {
    ...
    useEffect(() => {
        ...
        const filteredIndustryType = industrySolutions.filter((data) => data.title === industryType);
                    ...
                    {industrySolutions.slice(0, industrySolutions.length).map((solution, index) => (
                        <div key={index} className="custom-tab-container">
                            <input
                                ...
                                onChange={() => handleTabChange(solution.title)}
                            />
                                ...
                                <div className="row">
                                    <div className="col-xl-6 tab-content-image">
                                        <Tilt scale={scale} transitionSpeed={4000}>
                                            <img
                                                src={`${process.env.REACT_APP_PUBLIC_URL}/${solution.image}`} // Replace with actual path
                                                alt={solution.title}
