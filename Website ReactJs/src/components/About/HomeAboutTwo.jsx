                        ...
                        <div className="about-image-area about-shape-animation right-0 me-0">
                            <div className="about-image js-tilt">
                                <Tilt scale={scale} transitionSpeed={4000}>
                                    <img src={process.env.REACT_APP_PUBLIC_URL + "/images/about/about-1.jpg"} alt="/about-1" loading="lazy" />
                                </Tilt>
                            </div>
                            <div className="about-image js-tilt">
                                <Tilt scale={scale} transitionSpeed={4000}>
                                    <img src={process.env.REACT_APP_PUBLIC_URL + "/images/about/about-2.jpg"} alt="about-2" loading="lazy" />
                                </Tilt>
                            </div>
                            <div className="shape shape-1" id="scene" ref={sceneEl}>
                                <span data-depth="1"><img src={process.env.REACT_APP_PUBLIC_URL + "/images/shape-animation/video-shape-1.png"} alt="video-shape-1" loading="lazy" /></span>
                            </div>
                        </div>
                    </div>
